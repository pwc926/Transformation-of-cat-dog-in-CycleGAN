...
parser.add_argument('--name_data', type=str, default='cat2dog', dest='name_data')
...
parser.add_argument('--num_epoch', type=int,  default=120, dest='num_epoch')
...
parser.add_argument('--n_epochs', type=int, default=120, dest='n_epochs')
parser.add_argument('--n_epochs_decay', type=int, default=120, dest='n_epochs_decay')
...
parser.add_argument('--optimizer', default='adam', choices=['sgd', 'adam', 'rmsprop'], dest='optimizer')
...
parser.add_argument('--n_blocks', type=int, default=9, dest='n_blocks')
